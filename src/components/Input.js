...
import {  FaMicrophone, FaSearch, FaChevronLeft, FaVirus, FaSkull, FaHeartbeat, FaHeadSideCough, FaGlobe, FaPeopleArrows, FaThermometerThreeQuarters } from 'react-icons/fa';
...
const Input = () => {
  ...
  return (
    <>
    <p className="logo"> <span><FaVirus /></span> Covid-19 Tracker</p>
    <div className="navbar">
      ...
      {showSearchResult && filteredData &&  
        <section>
        <h2 className="Info title"> It locates in the
            {filteredData.continent} continent, here is the data:
            </h2>
